...
```dataview
TABLE source_file, type FROM #community/Programmable_Privacy__Midnight
SORT file.name ASC
```

## Connections to other communities
- 199 edges to [[_COMMUNITY_ZK Crypto Foundations]]
- 124 edges to [[_COMMUNITY_zkVMs & STARK Stacks]]
- 41 edges to [[_COMMUNITY_Arithmetization & CCS]]
- 24 edges to [[_COMMUNITY_Witness Generation & Hardware]]
- 11 edges to [[_COMMUNITY_Foundations & SoK Surveys]]
- 11 edges to [[_COMMUNITY_Sumcheck & Proving Overhead]]
- 9 edges to [[_COMMUNITY_ZK Identity & Enterprise]]
- 8 edges to [[_COMMUNITY_Privacy-Enhancing Technologies]]
- 4 edges to [[_COMMUNITY_Groth16 & Pairing SNARKs]]
- 4 edges to [[_COMMUNITY_PLONK & Permutation Arguments]]
- 4 edges to [[_COMMUNITY_Universal SRS & Ceremonies]]
- 3 edges to [[_COMMUNITY_Compliance & Deployment]]
- 3 edges to [[_COMMUNITY_ZK Bug Tooling]]
- 2 edges to [[_COMMUNITY_zkVM Fuzzing (Arguzz)]]
- 2 edges to [[_COMMUNITY_Under-Constrained Circuits (Picus)]]
- 1 edge to [[_COMMUNITY_Proof of Personhood & eIDAS]]
...
- 1 edge to [[_COMMUNITY_Nova Folding & IVC]]
