...
# Small-Space Proving (Twist/Shout)
...
```dataview
TABLE source_file, type FROM #community/Small-Space_Proving_Twist/Shout
SORT file.name ASC
```

## Connections to other communities
- 5 edges to [[_COMMUNITY_Sumcheck SNARKs (CCSLattice)]]
- 3 edges to [[_COMMUNITY_Sumcheck & Proving Overhead]]
