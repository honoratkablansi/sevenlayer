...
- [[Cairo]] - document - wiki/chapters/03-choreographing-the-act.md
...
- [[Circle STARKs]] - document - wiki/chapters/06-the-sealed-certificate.md
...
- [[ZK Coprocessors]] - document - wiki/chapters/13-the-market-landscape.md
...
- [[ZK Rollups]] - document - wiki/sections/ch13-zk-rollups-the-proving-grounds-production.md
- [[ZK Rollups The Proving Grounds (Production)]] - document - wiki/sections/ch13-zk-rollups-the-proving-grounds-production.md
- [[ZKML (Provable Machine Learning)]] - document - wiki/chapters/13-the-market-landscape.md
...
```dataview
TABLE source_file, type FROM #community/zkVMs__STARK_Stacks
SORT file.name ASC
```

## Connections to other communities
- 162 edges to [[_COMMUNITY_ZK Crypto Foundations]]
- 124 edges to [[_COMMUNITY_Programmable Privacy & Midnight]]
- 36 edges to [[_COMMUNITY_Sumcheck & Proving Overhead]]
- 35 edges to [[_COMMUNITY_Arithmetization & CCS]]
- 13 edges to [[_COMMUNITY_Witness Generation & Hardware]]
- 11 edges to [[_COMMUNITY_ZK Bug Tooling]]
- 9 edges to [[_COMMUNITY_ZK Identity & Enterprise]]
- 6 edges to [[_COMMUNITY_Jolt Lookup zkVM]]
- 6 edges to [[_COMMUNITY_Sumcheck SNARKs (CCSLattice)]]
- 6 edges to [[_COMMUNITY_zkVM Fuzzing (Arguzz)]]
- 6 edges to [[_COMMUNITY_STARK Foundations]]
- 5 edges to [[_COMMUNITY_Circle STARKs]]
- 4 edges to [[_COMMUNITY_Under-Constrained Circuits (Picus)]]
- 3 edges to [[_COMMUNITY_Compliance & Deployment]]
...
- 2 edges to [[_COMMUNITY_Proof of Personhood & eIDAS]]
- 2 edges to [[_COMMUNITY_Small-Space Proving (TwistShout)]]
...
- 1 edge to [[_COMMUNITY_HyperNova Multifolding]]
...
- 1 edge to [[_COMMUNITY_Universal SRS & Ceremonies]]

## Top bridge nodes
- [[Choreographing the Act]] - degree 44, connects to 9 communities
- [[FRI]] - degree 55, connects to 8 communities
- [[zkVMs -- The Universal Stage]] - degree 49, connects to 8 communities
- [[Zero-Knowledge Virtual Machine (zkVM)]] - degree 31, connects to 8 communities
- [[STARK (Scalable Transparent ARgument of Knowledge)]] - degree 56, connects to 7 communities