...
```dataview
TABLE source_file, type FROM #community/Lasso_Lookup_Arguments
SORT file.name ASC
```
...
- 4 edges to [[_COMMUNITY_Sumcheck & Proving Overhead]]
- 2 edges to [[_COMMUNITY_zkVMs & STARK Stacks]]
- 2 edges to [[_COMMUNITY_Sumcheck SNARKs (CCSLattice)]]
