...
```dataview
TABLE source_file, type FROM #community/PQC_Transition_NIST_IR_8547
SORT file.name ASC
```
...
## Top bridge nodes
- [[Transition to Post-Quantum Cryptography Standards (NIST IR 8547)]] - degree 13, connects to 6 communities
...
- [[PQC signature replacements ML-DSA-446587, SLH-DSA, LMSHSS, XMSS]] - degree 2, connects to 1 community
- [[PQC-Classical Hybrid Protocols (composite KEM via SP 800-56C, dual signatures)]] - degree 2, connects to 1 community