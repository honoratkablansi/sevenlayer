...
```dataview
TABLE source_file, type FROM #community/World__Proof_of_Personhood
SORT file.name ASC
```

## Connections to other communities
- 2 edges to [[_COMMUNITY_Core Concepts & Book Spine]]
- 2 edges to [[_COMMUNITY_eIDAS & Digital Identity]]
...
- [[Digital Identity]] - degree 5, connects to 1 community
...
- [[Semaphore generic open-source zk-SNARK group-membership and signaling protocol for Ethereum (Groth16-verifiable)]] - degree 3, connects to 1 community