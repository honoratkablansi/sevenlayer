...
```dataview
TABLE source_file, type FROM #community/Circuit_Static_Analysis_ZKAP
SORT file.name ASC
```

## Connections to other communities
- 4 edges to [[_COMMUNITY_Circom Vulnerability Taxonomy]]
- 3 edges to [[_COMMUNITY_Programmable Privacy & Midnight]]
- 3 edges to [[_COMMUNITY_Under-Constrained Circuits (Picus)]]
