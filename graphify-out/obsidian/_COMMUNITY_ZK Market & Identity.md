...
```dataview
TABLE source_file, type FROM #community/ZK_Market__Identity
SORT file.name ASC
```

## Connections to other communities
- 8 edges to [[_COMMUNITY_Coprocessors & ZKML]]
- 6 edges to [[_COMMUNITY_STARKs & zkVM Landscape]]
- 5 edges to [[_COMMUNITY_Privacy-Enhancing Technologies]]
- 5 edges to [[_COMMUNITY_Arithmetization & Proving Frontiers]]
- 4 edges to [[_COMMUNITY_Midnight Privacy Stack]]
...
- [[Proving-as-a-Service The Prover Market (Production)]] - degree 14, connects to 5 communities
...
- [[eIDAS 2.0]] - degree 8, connects to 2 communities