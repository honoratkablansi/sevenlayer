...
- [[STARKs]] - document - wiki/chapters/08-the-verdict.md
...
- [[Small-Field Proving]] - document - wiki/chapters/07-the-deep-craft.md
...
```dataview
TABLE source_file, type FROM #community/STARKs__zkVM_Landscape
SORT file.name ASC
```

## Connections to other communities
- 122 edges to [[_COMMUNITY_Commitments & Post-Quantum Craft]]
- 113 edges to [[_COMMUNITY_Arithmetization & Proving Frontiers]]
- 64 edges to [[_COMMUNITY_Trusted Setup & SNARK Foundations]]
- 59 edges to [[_COMMUNITY_Midnight Privacy Stack]]
- 25 edges to [[_COMMUNITY_Rollup Security, Attacks & Aggregation]]
- 14 edges to [[_COMMUNITY_Coprocessors & ZKML]]
- 6 edges to [[_COMMUNITY_ZK Market & Identity]]
- 1 edge to [[_COMMUNITY_Pairings & Quantum Threat]]
- 1 edge to [[_COMMUNITY_Privacy-Enhancing Technologies]]
- 1 edge to [[_COMMUNITY_Rollups & Private Smart Contracts]]

## Top bridge nodes
- [[The Synthesis -- Three Paths, Not Two]] - degree 52, connects to 7 communities
- [[SP1  SP1 Hypercube]] - degree 32, connects to 7 communities
- [[ZK Rollups The Proving Grounds (Production)]] - degree 25, connects to 6 communities
- [[Stwo]] - degree 17, connects to 6 communities
- [[STARKs]] - degree 55, connects to 5 communities