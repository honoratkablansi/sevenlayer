...
- [[KZG Polynomial Commitment Scheme]] - paper - references/ch02/ref-07-plonk.pdf
...
```dataview
TABLE source_file, type FROM #community/PLONK__Permutation_Arguments
SORT file.name ASC
```
...
- [[KZG Polynomial Commitment Scheme]] - degree 5, connects to 3 communities
