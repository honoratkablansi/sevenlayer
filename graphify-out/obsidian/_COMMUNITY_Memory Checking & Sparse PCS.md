...
```dataview
TABLE source_file, type FROM #community/Memory_Checking__Sparse_PCS
SORT file.name ASC
```

## Connections to other communities
- 3 edges to [[_COMMUNITY_Sumcheck & Small-Space zkVMs]]
...
## Top bridge nodes
- [[Offline memory checking]] - degree 11, connects to 5 communities
...
- [[Sparse multilinear polynomial commitment (Spartan compiler)]] - degree 3, connects to 1 community