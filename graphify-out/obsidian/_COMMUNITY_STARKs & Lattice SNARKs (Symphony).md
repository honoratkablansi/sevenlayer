...
# STARKs & Lattice SNARKs (Symphony)
...
```dataview
TABLE source_file, type FROM #community/STARKs__Lattice_SNARKs_Symphony
SORT file.name ASC
```

## Connections to other communities
- 11 edges to [[_COMMUNITY_Core Concepts & Book Spine]]
- 11 edges to [[_COMMUNITY_Folding & Lattice Crypto]]
- 8 edges to [[_COMMUNITY_Arithmetization & CCS]]
- 5 edges to [[_COMMUNITY_Sumcheck & Small-Space zkVMs]]
- 2 edges to [[_COMMUNITY_Lattice Folding (LatticeFold)]]
- 2 edges to [[_COMMUNITY_Lattice PCS (Greyhound)]]
...
- [[Symphony Scalable SNARKs in the Random Oracle Model from Lattice-Based High-Arity Folding]] - degree 22, connects to 4 communities
- [[Lattice-based cryptography]] - degree 7, connects to 4 communities
