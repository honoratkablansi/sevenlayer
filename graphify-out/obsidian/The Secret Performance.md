...
- [[Memory The Binding Constraint]] - `part_of` [EXTRACTED]
...
- [[Witness]] - `defines` [EXTRACTED]
- [[Witness Generation]] - `references` [EXTRACTED]
- [[Witness Generation Costs]] - `part_of` [EXTRACTED]
- [[Witness-Constraint Divergence]] - `part_of` [EXTRACTED]
