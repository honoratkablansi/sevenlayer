...
```dataview
TABLE source_file, type FROM #community/Universal_SRS__Sonic
SORT file.name ASC
```

## Connections to other communities
- 11 edges to [[_COMMUNITY_Core Concepts & Book Spine]]
- 8 edges to [[_COMMUNITY_Trusted Setup Ceremonies]]
- 6 edges to [[_COMMUNITY_AGM Ceremony Soundness]]
- 4 edges to [[_COMMUNITY_Groth16 & Pairing SNARKs]]
- 4 edges to [[_COMMUNITY_Sonic Argument System]]
- 3 edges to [[_COMMUNITY_PLONK & Permutation Arguments]]
- 3 edges to [[_COMMUNITY_Ceremonial SNARK Model]]
- 3 edges to [[_COMMUNITY_Knowledge-of-Exponent Assumptions]]
- 3 edges to [[_COMMUNITY_Subversion-Resistant CRS]]
- 2 edges to [[_COMMUNITY_Bulletproofs & Range Proofs]]
- 1 edge to [[_COMMUNITY_zkEVM & Real-Time Proving]]
...
- [[Snarky Ceremonies]] - degree 21, connects to 4 communities
- [[Updatable & specializable QAP-based zk-SNARK construction]] - degree 6, connects to 3 communities
- [[Sonic Zero-Knowledge SNARKs from Linear-Size Universal and Updatable Structured Reference Strings]] - degree 13, connects to 2 communities