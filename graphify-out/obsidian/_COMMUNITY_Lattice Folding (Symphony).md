...
```dataview
TABLE source_file, type FROM #community/Lattice_Folding_Symphony
SORT file.name ASC
```

## Connections to other communities
- 21 edges to [[_COMMUNITY_ZK Crypto Foundations]]
- 7 edges to [[_COMMUNITY_Sumcheck SNARKs (CCSLattice)]]
