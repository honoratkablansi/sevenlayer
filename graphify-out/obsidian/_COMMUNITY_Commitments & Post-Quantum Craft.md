...
# Commitments & Post-Quantum Craft
...
- [[Inner Product Arguments (IPA)]] - document - wiki/chapters/07-the-deep-craft.md
...
- [[Pedersen Commitment]] - document - wiki/sections/ch07-the-quantum-threat-horizon.md
...
- [[Shor's Algorithm_1]] - document - proving-nothing.md
...
```dataview
TABLE source_file, type FROM #community/Commitments__Post-Quantum_Craft
SORT file.name ASC
```

## Connections to other communities
- 122 edges to [[_COMMUNITY_STARKs & zkVM Landscape]]
...
- 1 edge to [[_COMMUNITY_FHE & Compiler Infrastructure]]
- 1 edge to [[_COMMUNITY_ZK Market & Identity]]

## Top bridge nodes
- [[Lattice Cryptography]] - degree 54, connects to 7 communities
- [[Layer 5 -- The Sealed Certificate]] - degree 71, connects to 6 communities
- [[Layer 6 -- The Deep Craft]] - degree 65, connects to 6 communities
- [[KZG Polynomial Commitments]] - degree 57, connects to 6 communities
- [[Trusted Setup]] - degree 35, connects to 6 communities