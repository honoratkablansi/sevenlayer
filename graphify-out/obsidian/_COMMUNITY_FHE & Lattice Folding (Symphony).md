...
```dataview
TABLE source_file, type FROM #community/FHE__Lattice_Folding_Symphony
SORT file.name ASC
```
...
- 4 edges to [[_COMMUNITY_Sumcheck SNARKs (SuperSpartan)]]
- 4 edges to [[_COMMUNITY_Lattice Folding (Neo)]]
...
- 1 edge to [[_COMMUNITY_Universal SRS & Sonic]]
