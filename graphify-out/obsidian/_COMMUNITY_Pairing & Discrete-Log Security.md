...
```dataview
TABLE source_file, type FROM #community/Pairing__Discrete-Log_Security
SORT file.name ASC
```
...
- 1 edge to [[_COMMUNITY_Quantum-Vulnerable Crypto & PQC Schedule]]

## Top bridge nodes
- [[Extended Tower Number Field Sieve A New Complexity for the Medium Prime Case]] - degree 7, connects to 4 communities
- [[Discrete Logarithm Problem]] - degree 7, connects to 3 communities
- [[exTNFS (Extended Tower Number Field Sieve)]] - degree 15, connects to 1 community
