...
```dataview
TABLE source_file, type FROM #community/zkVM_Design_Philosophy
SORT file.name ASC
```

## Connections to other communities
- 61 edges to [[_COMMUNITY_Core Concepts & Book Spine]]
- 36 edges to [[_COMMUNITY_zkVM & STARK Stacks]]
- 14 edges to [[_COMMUNITY_Arithmetization & CCS]]
- 11 edges to [[_COMMUNITY_Witness Generation & Hashing]]
- 8 edges to [[_COMMUNITY_zkEVM & Real-Time Proving]]
- 7 edges to [[_COMMUNITY_zkVM Compiler Optimization]]
- 6 edges to [[_COMMUNITY_Circuit Verification (Coda)]]
- 6 edges to [[_COMMUNITY_zkVM Fuzzing (Arguzz)]]
- 4 edges to [[_COMMUNITY_Folding Genealogy & Post-Quantum]]
- 3 edges to [[_COMMUNITY_SNARK Vulnerabilities & Foundations]]
- 3 edges to [[_COMMUNITY_Jolt Lookup zkVM]]
- 2 edges to [[_COMMUNITY_ZK Identity & Market]]
...
- 1 edge to [[_COMMUNITY_Small-Space CPU Proofs]]
- 1 edge to [[_COMMUNITY_FHE & Lattice Folding (Symphony)]]
- 1 edge to [[_COMMUNITY_ZKML & Coprocessors]]
