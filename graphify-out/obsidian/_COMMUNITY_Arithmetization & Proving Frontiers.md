...
# Arithmetization & Proving Frontiers
...
- [[Side-Channel Attacks_1]] - document - proving-nothing.md
...
```dataview
TABLE source_file, type FROM #community/Arithmetization__Proving_Frontiers
SORT file.name ASC
```

## Connections to other communities
- 118 edges to [[_COMMUNITY_Commitments & Post-Quantum Craft]]
...
- 2 edges to [[_COMMUNITY_FHE & Compiler Infrastructure]]

## Top bridge nodes
- [[Open Questions and the Road Ahead]] - degree 49, connects to 8 communities
- [[The Secret Performance]] - degree 44, connects to 7 communities
- [[The Seven Questions That Remain Open]] - degree 36, connects to 6 communities
- [[The Overhead Tax 10,000x to 50,000x]] - degree 32, connects to 6 communities
- [[Coda]] - degree 25, connects to 6 communities