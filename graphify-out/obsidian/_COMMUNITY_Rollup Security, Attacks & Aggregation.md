...
```dataview
TABLE source_file, type FROM #community/Verification__Fiat-Shamir
SORT file.name ASC
```

## Connections to other communities
- 40 edges to [[_COMMUNITY_Commitments & Post-Quantum Craft]]
- 30 edges to [[_COMMUNITY_Trusted Setup & SNARK Foundations]]
- 25 edges to [[_COMMUNITY_STARKs & zkVM Landscape]]
- 22 edges to [[_COMMUNITY_Arithmetization & Proving Frontiers]]
- 20 edges to [[_COMMUNITY_Midnight Privacy Stack]]
- 7 edges to [[_COMMUNITY_Privacy-Enhancing Technologies]]
...
- [[Layer 7 -- The Verdict]] - degree 42, connects to 6 communities
- [[Fiat-Shamir Transform]] - degree 35, connects to 6 communities
- [[The Sealed Certificate (Chapter Closing)]] - degree 20, connects to 6 communities