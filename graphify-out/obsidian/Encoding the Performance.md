...
## Connections
- [[AIR (Algebraic Intermediate Representation)]] - `references` [EXTRACTED]
- [[Airbender]] - `references` [EXTRACTED]
- [[Arithmetization]] - `references` [EXTRACTED]
...
- [[CCS The Rosetta Stone]] - `part_of` [EXTRACTED]
...
- [[The Sumcheck Protocol The Hidden Foundation]] - `part_of` [EXTRACTED]
- [[Tornado Cash]] - `references` [EXTRACTED]
- [[Unlocking the Lookup Singularity with Lasso]] - `cites` [EXTRACTED]
- [[Where the Analogies Break]] - `part_of` [EXTRACTED]
- [[Where the Layers Collapse]] - `part_of` [EXTRACTED]
- [[ZKIR (Midnight Intermediate Representation)]] - `references` [EXTRACTED]
- [[ZKIR Intermediate Representation Reference (Midnight Network, stub)]] - `cites` [EXTRACTED]
