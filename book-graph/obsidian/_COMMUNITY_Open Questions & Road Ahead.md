...
```dataview
TABLE source_file, type FROM #community/Open_Questions__Road_Ahead
SORT file.name ASC
```

## Connections to other communities
- 4 edges to [[_COMMUNITY_Compilation & Witness Generation]]
- 2 edges to [[_COMMUNITY_Midnight & Private Contracts]]
- 2 edges to [[_COMMUNITY_Lookups & zkVM Arithmetic]]
...
- [[The Three Frontiers (Performance, Security, Privacy)]] - degree 6, connects to 1 community
- [[Q7 Is Seven the Right Number of Layers]] - degree 4, connects to 1 community
- [[Constant-Time Implementation]] - degree 3, connects to 1 community
- [[Side-Channel Attack_1]] - degree 3, connects to 1 community