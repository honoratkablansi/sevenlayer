...
```dataview
TABLE source_file, type FROM #community/CirC_Compiler_Infrastructure
SORT file.name ASC
```
...
## Top bridge nodes
- [[CirC shared compiler infrastructure for EQCs]] - degree 5, connects to 2 communities
- [[CirC Compiler Infrastructure for Proof Systems, Software Verification, and More]] - degree 4, connects to 2 communities
- [[Existentially Quantified Circuit (EQC)]] - degree 4, connects to 1 community