...
```dataview
TABLE source_file, type FROM #community/ProtoStar_Accumulation
SORT file.name ASC
```
...
- [[Homomorphic Sparse Error-Commitment Update for Lookups (O(l) indep. of T)]] - degree 2, connects to 1 community