...
```dataview
TABLE source_file, type FROM #community/Nova_Folding_Scheme
SORT file.name ASC
```

## Connections to other communities
- 3 edges to [[_COMMUNITY_Circuit Security & Constraint Systems]]
- 2 edges to [[_COMMUNITY_Recursive Proofs & IVC]]
...
- [[CycleFold cycle-of-curves delegation technique]] - degree 3, connects to 1 community
- [[NovaBlindFold folding-based zero-knowledge]] - degree 3, connects to 1 community
- [[Forking Lemma for Folding Schemes (Lemma 1)]] - degree 2, connects to 1 community