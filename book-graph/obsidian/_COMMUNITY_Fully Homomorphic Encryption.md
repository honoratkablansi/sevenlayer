...
```dataview
TABLE source_file, type FROM #community/Fully_Homomorphic_Encryption
SORT file.name ASC
```
...
## Top bridge nodes
- [[Bootstrapping (FHE)]] - degree 6, connects to 1 community
...
- [[Bootstrapping theorem any bootstrappable scheme yields leveled FHE family {E(d)} (Thm 1,3)]] - degree 3, connects to 1 community