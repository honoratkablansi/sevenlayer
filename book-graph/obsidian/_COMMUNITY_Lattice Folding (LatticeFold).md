...
```dataview
TABLE source_file, type FROM #community/Lattice_Folding_LatticeFold
SORT file.name ASC
```

## Connections to other communities
- 3 edges to [[_COMMUNITY_Lattice Folding (LatticeFold)]]
- 2 edges to [[_COMMUNITY_Commitments & Cryptographic Hardness]]
...
## Top bridge nodes
- [[B-Bounded Ajtai Commitment Opening Relation RB_cm]] - degree 6, connects to 3 communities
- [[Expansion-Decomposition-Folding Pipeline (Pi_mfold)]] - degree 7, connects to 1 community
- [[Lattice-Based CCS Folding Scheme]] - degree 4, connects to 1 community
- [[Expanded Evaluation Relation RB_eval]] - degree 3, connects to 1 community
- [[B-Relaxed Binding of Ajtai Commitment]] - degree 3, connects to 1 community