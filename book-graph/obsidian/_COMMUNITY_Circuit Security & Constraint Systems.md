...
# Circuit Security & Constraint Systems
...
```dataview
TABLE source_file, type FROM #community/Circuit_Security__Constraint_Systems
SORT file.name ASC
```

## Connections to other communities
- 5 edges to [[_COMMUNITY_Proof Systems & Trusted Setup]]
- 4 edges to [[_COMMUNITY_Arithmetization & ZK Languages]]
- 4 edges to [[_COMMUNITY_Commitments & Cryptographic Hardness]]
- 2 edges to [[_COMMUNITY_Fiat-Shamir Security & Synthesis]]
