...
# Lattice Functional Commitments
...
```dataview
TABLE source_file, type FROM #community/Lattice_Functional_Commitments
SORT file.name ASC
```

## Connections to other communities
- 5 edges to [[_COMMUNITY_Lattice Functional Commitments]]

## Top bridge nodes
- [[Oblivious Sampling Cryptanalysis (Babai-rounding attack breaking extractability  knowledge k-R-ISIS plausibility)]] - degree 6, connects to 1 community
- [[Knowledge k-R-ISIS Assumption (Albrecht et al. CRYPTO 2022)]] - degree 4, connects to 1 community
- [[Extractable Functional Commitment (equivalent to SNARG for NP via quadratic relations)]] - degree 3, connects to 1 community
- [[Inhomogeneous SIS Assumption]] - degree 2, connects to 1 community