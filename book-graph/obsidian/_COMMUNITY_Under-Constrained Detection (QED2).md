...
# Under-Constrained Detection (QED2)
...
```dataview
TABLE source_file, type FROM #community/Under-Constrained_Detection_QED2
SORT file.name ASC
```

## Connections to other communities
- 3 edges to [[_COMMUNITY_Circuit Verification (Coda)]]
- 3 edges to [[_COMMUNITY_Circuit Static Analysis (ZKAP)]]
- 2 edges to [[_COMMUNITY_Circom Vulnerability Taxonomy]]
- 1 edge to [[_COMMUNITY_Coda Type System & Coq]]

## Top bridge nodes
- [[Underconstrained Circuits]] - degree 12, connects to 4 communities
- [[Automated Detection of Under-Constrained Circuits in Zero-Knowledge Proofs]] - degree 7, connects to 2 communities
