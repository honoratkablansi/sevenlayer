...
```dataview
TABLE source_file, type FROM #community/ZK_Foundations__SNARK_Security
SORT file.name ASC
```

## Connections to other communities
- 3 edges to [[_COMMUNITY_Digital Identity & Proof of Personhood]]
- 2 edges to [[_COMMUNITY_ZK Foundations & Framing]]
...
- 1 edge to [[_COMMUNITY_SNARK Vulnerability Layers]]
- 1 edge to [[_COMMUNITY_Privacy Pools & Zerocash]]
- 1 edge to [[_COMMUNITY_Privacy Pools Compliance]]
