...
```dataview
TABLE source_file, type FROM #community/MPC_Powers-of-Tau_Ceremony
SORT file.name ASC
```

## Connections to other communities
- 5 edges to [[_COMMUNITY_Trusted Setup Ceremonies]]
- 3 edges to [[_COMMUNITY_Updatable CRS & KoE Assumptions]]
- 1 edge to [[_COMMUNITY_Groth16 & Pairing SNARKs]]
- 1 edge to [[_COMMUNITY_Groth16 & Pairing SNARKs]]
- 1 edge to [[_COMMUNITY_Universal SRS & Ceremonies]]

## Top bridge nodes
- [[MMORPG massively multi-party open reusable parameter generation system]] - degree 7, connects to 2 communities
- [[Random Beacon Model]] - degree 6, connects to 2 communities
- [[Scalable Multi-party Computation for zk-SNARK Parameters in the Random Beacon Model]] - degree 5, connects to 2 communities
...
- [[Extended Groth CRS depth-two-circuit-computable CRS enabling two-phase px-MPC]] - degree 2, connects to 1 community