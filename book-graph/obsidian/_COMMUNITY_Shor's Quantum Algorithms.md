...
```dataview
TABLE source_file, type FROM #community/Shors_Quantum_Algorithms
SORT file.name ASC
```

## Connections to other communities
- 3 edges to [[_COMMUNITY_Pairing & Discrete-Log Security]]
...
## Top bridge nodes
- [[Shor's Algorithm]] - degree 6, connects to 2 communities
- [[Algorithms for Quantum Computation Discrete Logarithms and Factoring]] - degree 11, connects to 1 community
