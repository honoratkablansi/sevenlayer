...
```dataview
TABLE source_file, type FROM #community/Trusted_Setup_Ceremonies
SORT file.name ASC
```

## Connections to other communities
- 6 edges to [[_COMMUNITY_Commitments & Cryptographic Hardness]]
- 5 edges to [[_COMMUNITY_MPC Powers-of-Tau Ceremony]]
- 5 edges to [[_COMMUNITY_Updatable CRS & KoE Assumptions]]
- 3 edges to [[_COMMUNITY_Universal SRS & Ceremonies]]
- 2 edges to [[_COMMUNITY_Proof Systems & Trusted Setup]]

## Top bridge nodes
- [[Powers of Tau]] - degree 17, connects to 5 communities
...
- [[SoK Trusted Setups for Powers-of-Tau Strings]] - degree 8, connects to 1 community
