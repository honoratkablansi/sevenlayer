...
```dataview
TABLE source_file, type FROM #community/Updatable_CRS__KoE_Assumptions
SORT file.name ASC
```

## Connections to other communities
- 5 edges to [[_COMMUNITY_Trusted Setup Ceremonies]]
- 5 edges to [[_COMMUNITY_Sonic Argument System]]
- 3 edges to [[_COMMUNITY_Groth16 & Pairing SNARKs]]
...
- 1 edge to [[_COMMUNITY_Ceremonial SNARK Model]]
