...
# Digital Identity & Proof of Personhood
...
```dataview
TABLE source_file, type FROM #community/Digital_Identity__Proof_of_Personhood
SORT file.name ASC
```

## Connections to other communities
- 5 edges to [[_COMMUNITY_Digital Identity & Proof of Personhood]]
