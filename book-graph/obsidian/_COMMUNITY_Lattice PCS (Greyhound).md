...
```dataview
TABLE source_file, type FROM #community/Lattice_PCS_Greyhound
SORT file.name ASC
```
...
## Top bridge nodes
- [[Greyhound polynomial commitment scheme]] - degree 11, connects to 5 communities
...
- [[Bivariate polynomial folding f(X,Y)=aT S b with Y=Xm]] - degree 2, connects to 1 community
- [[AVX-512 multi-modular NTT ring arithmetic library]] - degree 2, connects to 1 community