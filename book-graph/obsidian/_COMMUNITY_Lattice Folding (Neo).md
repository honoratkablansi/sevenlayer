...
```dataview
TABLE source_file, type FROM #community/Lattice_Folding_Neo
SORT file.name ASC
```

## Connections to other communities
- 4 edges to [[_COMMUNITY_Lattice Folding (LatticeFold+)]]
- 3 edges to [[_COMMUNITY_Circuit Security & Constraint Systems]]
- 2 edges to [[_COMMUNITY_Lattice Folding (LatticeFold)]]
- 1 edge to [[_COMMUNITY_Commitments & Cryptographic Hardness]]
- 1 edge to [[_COMMUNITY_Bitcoin Quantum Risk (HNDL)]]
- 1 edge to [[_COMMUNITY_Recursive Proofs & IVC]]
- 1 edge to [[_COMMUNITY_Jolt Lookup zkVM]]

## Top bridge nodes
- [[Neo Lattice-based Folding Scheme for CCS over Small Fields and Pay-per-bit Commitments]] - degree 22, connects to 7 communities
- [[Neo folding scheme for CCS (lattice-based)]] - degree 8, connects to 1 community
- [[Strong sampling set with small-norm invertible challenges (expansion factor T)]] - degree 4, connects to 1 community
- [[HyperNova (CRYPTO'24)]] - degree 3, connects to 1 community
- [[LatticeFold (ePrint 2024257)]] - degree 3, connects to 1 community