...
```dataview
TABLE source_file, type FROM #community/Sumcheck__Small-Space_zkVMs
SORT file.name ASC
```
...
- 1 edge to [[_COMMUNITY_Lookups & zkVM Arithmetic]]
- 1 edge to [[_COMMUNITY_Sumcheck & Small-Space zkVMs]]
- 1 edge to [[_COMMUNITY_zkVM Fuzzing (Arguzz)]]

## Top bridge nodes
- [[Small-space Jolt prover (sublinear-space zkVM proving without recursion)]] - degree 8, connects to 2 communities
- [[Jolt sum-check-based zkVM for RISC-V]] - degree 6, connects to 2 communities
...
- [[Concrete cost estimate ~900T linear-space vs ~900T+12T log T small-space field mults]] - degree 3, connects to 1 community