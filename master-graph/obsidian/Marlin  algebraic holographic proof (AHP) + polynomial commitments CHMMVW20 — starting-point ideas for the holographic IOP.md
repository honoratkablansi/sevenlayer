...
## Connections
- [[Connection between holography and preprocessing in the random oracle model]] - `cites` [EXTRACTED]
- [[Holographic lincheck and sparse matrix arithmetization protocol (rational extension of summand; one fewer round than Marlin)]] - `conceptually_related_to` [EXTRACTED]
