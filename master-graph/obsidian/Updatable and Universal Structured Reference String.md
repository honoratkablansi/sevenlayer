...
## Connections
- [[GKM+18 - Groth, Kohlweiss, Maller, Meiklejohn, Miers Updatable and universal CRS]] - `conceptually_related_to` [EXTRACTED]
- [[SNARK (Succinct Non-interactive ARgument of Knowledge)]] - `uses` [EXTRACTED]
- [[Secure multi-party computation (MPC)  two-party computation (2PC)]] - `uses` [EXTRACTED]
- [[Setup taxonomy public-cointransparent vs private-coin; circuit-specific vs universal vs updatable]] - `defines` [EXTRACTED]
- [[Snarky Ceremonies]] - `references` [EXTRACTED]
- [[Snarky Ceremonies (relaxed-security MMORPG variant; no random beacon needed)]] - `conceptually_related_to` [EXTRACTED]
...
- [[Universal Common Reference String]] - `relates_to` [EXTRACTED]
