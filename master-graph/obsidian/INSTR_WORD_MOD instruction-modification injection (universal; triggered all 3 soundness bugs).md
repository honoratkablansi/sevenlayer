...
- [[Injection-type taxonomy (PC mod, ALU resultoperand, memreg mod, DIVREM flips, ecall id, branch invert)]] - `conceptually_related_to` [EXTRACTED]
- [[JOLT bug6 (soundness) unconstrained immediate operand in lui instruction]] - `conceptually_related_to` [EXTRACTED]
- [[Malicious-prover fault injection into VM execution logic (verifier-only-trusted threat model)]] - `defines` [EXTRACTED]
