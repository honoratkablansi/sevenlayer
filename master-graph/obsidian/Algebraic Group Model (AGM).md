...
## Connections
- [[Algebraic extractor E_agm (white-box, requires view_A, yields linear representation coefficients)]] - `conceptually_related_to` [EXTRACTED]
...
- [[Theorem 2 Pi_dl is complete, perfect ZK, straight-line SE under (1,0)-dlog in AGM+RO]] - `assumes` [EXTRACTED]
