...
- [[Cyclic Group]] - `uses` [EXTRACTED]
- [[Decisional Diffie-Hellman (DDH) assumption over secp256k1]] - `builds_on` [EXTRACTED]
- [[Discrete Log Relation Assumption]] - `conceptually_related_to` [EXTRACTED]
- [[Elliptic Curve Group]] - `relates_to` [EXTRACTED]
...
- [[Schnorr Proof System]] - `uses` [EXTRACTED]
