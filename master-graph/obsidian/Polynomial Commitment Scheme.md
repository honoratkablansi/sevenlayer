...
- [[Brakedown Polynomial Commitment]] - `builds_on` [EXTRACTED]
...
- [[Coefficient Matrix (Polynomial)]] - `uses` [EXTRACTED]
...
- [[DARK Polynomial Commitment (Bunz-Fisch-Szepieniec 2020)]] - `defines` [EXTRACTED]
...
- [[Error-Correcting Code]] - `builds_on` [EXTRACTED]
...
- [[KZG Polynomial Commitment]] - `defines` [EXTRACTED]
...
- [[Ligero]] - `builds_on` [EXTRACTED]
- [[Linear-Time Encodable Code]] - `uses` [EXTRACTED]
- [[List Polynomial Commitment Scheme]] - `generalizes` [EXTRACTED]
...
- [[Polynomial IOP (Poly-IOP)]] - `uses` [EXTRACTED]
...
- [[Post-Quantum Security]] - `relates_to` [EXTRACTED]
...
- [[Schwartz-Zippel Lemma]] - `builds_on` [EXTRACTED]
...
- [[Vector commitment scheme (position-binding; Merkle-tree instantiation, O(log n) openings)]] - `builds_on` [EXTRACTED]
