...
## Connections
- [[Arithmetic Circuit]] - `reduces_to` [EXTRACTED]
- [[Back End (Argument System for Circuit Evaluation)]] - `relates_to` [EXTRACTED]
...
- [[Machine Code  Random Access Machine (RAM)]] - `relates_to` [EXTRACTED]
