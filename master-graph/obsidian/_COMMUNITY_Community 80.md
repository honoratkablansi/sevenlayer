...
- [[Image Authentication (IA) proving an image faithfully represents an original photograph from a given capture device class]] - degree 6, connects to 1 community
