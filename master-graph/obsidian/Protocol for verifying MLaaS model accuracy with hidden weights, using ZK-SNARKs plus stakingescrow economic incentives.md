...
## Connections
- [[Proof of model provenance committing to hidden weights via a SNARK-friendly hash so a provider can prove it ran a specific committed model]] - `conceptually_related_to` [EXTRACTED]
