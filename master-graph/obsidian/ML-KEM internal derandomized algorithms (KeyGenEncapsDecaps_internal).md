...
## Connections
- [[Implicit rejection mechanism (re-encryption ciphertext comparison)]] - `defines` [EXTRACTED]
- [[K-PKE component public-key encryption scheme (KeyGenEncryptDecrypt)]] - `shares_data_with` [EXTRACTED]
- [[ML-KEM.Decaps (deterministic decapsulation, Algorithm 21)]] - `shares_data_with` [EXTRACTED]
