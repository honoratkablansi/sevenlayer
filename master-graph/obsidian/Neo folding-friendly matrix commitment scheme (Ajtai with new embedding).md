...
- [[S-module homomorphism via ring of rotation matrices S]] - `defines` [EXTRACTED]
- [[Strong sampling set with small-norm invertible challenges (expansion factor T)]] - `defines` [EXTRACTED]
