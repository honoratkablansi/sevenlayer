...
## Connections
- [[CRYSTALS-Kyber KEM (round-three NIST PQC submission)]] - `standardizes` [EXTRACTED]
...
- [[Key-Encapsulation Mechanism (KEM)]] - `implements` [EXTRACTED]
- [[ML-KEM (Module-Lattice-Based Key-Encapsulation Mechanism, FIPS 203)]] - `conceptually_related_to` [EXTRACTED]
- [[Module Learning With Errors (MLWE)]] - `based_on` [EXTRACTED]
...
- [[Public-Key Encryption]] - `relates_to` [EXTRACTED]
