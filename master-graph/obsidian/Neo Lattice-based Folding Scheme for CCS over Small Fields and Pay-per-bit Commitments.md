...
- [[Lattice IVCPCD with Spartan+FRI proof compression, no curve cycles]] - `introduces` [EXTRACTED]
- [[Lattice folding for lookups and read-write memory via ShoutTwist]] - `introduces` [EXTRACTED]
- [[LatticeFold (ePrint 2024257)]] - `shares_data_with` [INFERRED]
...
- [[Lemma 2 linear combinations of commitments respect right-multiplication of openings]] - `proves` [EXTRACTED]
- [[Lova (unstructured-lattice folding for subset sum)]] - `cites` [EXTRACTED]
- [[Neo folding scheme for CCS (lattice-based)]] - `introduces` [EXTRACTED]
- [[Neo folding-friendly matrix commitment scheme (Ajtai with new embedding)]] - `introduces` [EXTRACTED]
