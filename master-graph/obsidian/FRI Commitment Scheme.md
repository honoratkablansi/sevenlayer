...
- [[FRI Blowup Factor]] - `defines` [EXTRACTED]
- [[FRI Folding (Commitment and Query Phases)]] - `defines` [EXTRACTED]
- [[FRI Query Phase]] - `defines` [EXTRACTED]
...
- [[List Polynomial Commitment Scheme]] - `builds_on` [EXTRACTED]
- [[Lookup Argument]] - `references` [EXTRACTED]
- [[Low-Degree Testing]] - `builds_on` [EXTRACTED]
...
- [[Proximity Test]] - `builds_on` [EXTRACTED]
