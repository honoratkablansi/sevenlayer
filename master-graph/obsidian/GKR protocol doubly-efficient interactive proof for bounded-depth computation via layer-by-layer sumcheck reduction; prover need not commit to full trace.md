...
- [[Holographic  Preprocessing Argument System]] - `builds_on` [EXTRACTED]
- [[Incrementally Verifiable Computation (IVC)]] - `uses` [EXTRACTED]
- [[Interactive Proof (IP) prover-verifier protocol with statistical soundness]] - `generalizes` [EXTRACTED]
- [[Layered Arithmetic Circuit]] - `uses` [EXTRACTED]
...
- [[Log-Space Uniform Circuit]] - `uses` [EXTRACTED]
