...
- [[LogUp]] - `defines` [EXTRACTED]
- [[Mangrove]] - `uses` [EXTRACTED]
- [[Merkle ZKP membership proof]] - `relates_to` [EXTRACTED]
...
- [[Sparse Polynomial Commitment]] - `used` [EXTRACTED]
...
- [[Volatile RAM AIP (zeroed init, uncommitted final)]] - `cites` [EXTRACTED]
