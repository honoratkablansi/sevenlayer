...
## Connections
- [[Batched evaluation protocol for multiple pointspolynomials]] - `introduces` [EXTRACTED]
- [[Efficiency O(sqrt N) verifier, polylog proof, 53KB at N=230]] - `proves` [EXTRACTED]
...
- [[Split-and-fold  folding paradigm]] - `conceptually_related_to` [INFERRED]
- [[Theorem 4.1 completeness, weak binding, knowledge soundness of PCS]] - `proves` [EXTRACTED]
