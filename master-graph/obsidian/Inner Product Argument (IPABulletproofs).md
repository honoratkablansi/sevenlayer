...
## Connections
- [[AFGHO Inner-Pairing-Product Commitment]] - `relates_to` [EXTRACTED]
- [[Bilinear Pairing]] - `uses` [EXTRACTED]
- [[Bootle et al. (BCC+16) Inner-Product Argument]] - `conceptually_related_to` [EXTRACTED]
- [[Bootle, Cerulli, Chaidos, Groth, Petit Efficient ZK arguments in the discrete log setting (inner product argument) 12]] - `introduces` [EXTRACTED]
...
- [[Bunz et al., Bulletproofs (IEEE S&P 2018)]] - `cites` [EXTRACTED]
...
- [[Polynomial Commitment Scheme]] - `improves` [EXTRACTED]
- [[Proof Aggregation]] - `uses` [EXTRACTED]
- [[Recursive Halving in Inner Product Argument]] - `uses` [EXTRACTED]
