...
- [[GGPR quadratic arithmetic programs (QAPs)  Pinocchio trusted-setup SNARKs (cited prior work)]] - `cites` [EXTRACTED]
- [[Goldwasser-Kalai-Rothblum (GKR) doubly-efficient interactive proofs (cited prior work)]] - `cites` [EXTRACTED]
...
- [[Setty, Spartan Efficient and General-Purpose zkSNARKs without Trusted Setup (CRYPTO 2020  ePrint 2019550)]] - `introduces` [EXTRACTED]
...
- [[Theorem 1.1  Corollary 1.1 family of zkSNARKs, prover O(n)–O(n log n), verifierproof O(log² n)–O(√n)]] - `conceptually_related_to` [EXTRACTED]
- [[Three zkVMs Through Seven Layers]] - `conceptually_related_to` [EXTRACTED]
- [[Two-round sum-check public-coin succinct interactive argument of knowledge for R1CS (Theorem 5.1)]] - `introduces` [EXTRACTED]
