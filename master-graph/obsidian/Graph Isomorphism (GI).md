...
## Connections
- [[Graph Non-Isomorphism Protocol]] - `relates_to` [EXTRACTED]
- [[Interactive Proof (IP) prover-verifier protocol with statistical soundness]] - `example_of` [EXTRACTED]
- [[Knowledge-Soundness]] - `example_of` [EXTRACTED]
