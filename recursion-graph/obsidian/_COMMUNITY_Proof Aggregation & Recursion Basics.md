...
# Proof Aggregation & Recursion Basics
...
- [[Bilinear pairing on elliptic curves]] - paper - references/recursion/ch1/ref-02-bctv-cycles.pdf
...
- [[Cairo (CPU Algebraic Intermediate Representation)]] - document - references/recursion/ch3/ref-53-starkware-recursive-starks.md
...
- [[Groth16]] - document - recursion/recursion-outline.md
...
- [[KZG polynomial commitment]] - paper - references/recursion/ch1/ref-33-snarkpack.pdf
- [[Knowledge-of-exponent assumption (zk-SNARK security)]] - paper - references/recursion/ch1/ref-02-bctv-cycles.pdf
...
- [[Poseidon hash for ZKP systems]] - paper - references/recursion/ch1/ref-21-zktree.pdf
- [[Powers-of-tau structured reference string (SRS)]] - paper - references/recursion/ch1/ref-33-snarkpack.pdf
- [[Preprocessing zk-SNARK for arithmetic circuits]] - paper - references/recursion/ch1/ref-02-bctv-cycles.pdf
- [[Proof Aggregation]] - document - recursion/recursion-outline.md
...
```dataview
TABLE source_file, type FROM #community/Proof_Aggregation__Recursion_Basics
SORT file.name ASC
```

## Connections to other communities
- 5 edges to [[_COMMUNITY_Recursion Overview & History]]
- 5 edges to [[_COMMUNITY_Curve Cycles & Full Recursion]]
- 3 edges to [[_COMMUNITY_zkVMs & Real-Time Proving]]
- 2 edges to [[_COMMUNITY_Applications Cross-Chain & zkML]]
- 2 edges to [[_COMMUNITY_STARK Machinery (FRIAIR)]]
- 2 edges to [[_COMMUNITY_VerITAS Image Authentication]]
- 1 edge to [[_COMMUNITY_Proof-Carrying Data & Provenance]]
- 1 edge to [[_COMMUNITY_Polynomial-Commitment Accumulation]]
- 1 edge to [[_COMMUNITY_Accumulation & Proofs of Solvency]]
- 1 edge to [[_COMMUNITY_Nebra Universal Aggregation]]
- 1 edge to [[_COMMUNITY_Rollups & Strategy Framework]]
- 1 edge to [[_COMMUNITY_zkEmail & Web Provenance]]
- 1 edge to [[_COMMUNITY_STARK Recursion & Taxonomy]]

## Top bridge nodes
- [[Proof Aggregation]] - degree 20, connects to 7 communities
- [[Plonky2]] - degree 8, connects to 3 communities
- [[Groth16]] - degree 10, connects to 2 communities
- [[Recursive STARK proving]] - degree 7, connects to 1 community
- [[Bilinear pairing on elliptic curves]] - degree 6, connects to 1 community