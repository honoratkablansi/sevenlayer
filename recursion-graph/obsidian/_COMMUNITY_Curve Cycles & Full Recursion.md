...
- [[Bootstrapping transformation (BCCT13)]] - paper - references/recursion/ch1/ref-02-bctv-cycles.pdf
...
- [[Collision-resistant hashing (field-specific subset-sum)]] - paper - references/recursion/ch1/ref-02-bctv-cycles.pdf
...
- [[Cycles of Elliptic Curves]] - document - recursion/recursion-outline.md
...
- [[Embedding degree of elliptic curve]] - paper - references/recursion/ch1/ref-02-bctv-cycles.pdf
...
- [[Pasta Curves]] - document - recursion/recursion-outline.md
...
```dataview
TABLE source_file, type FROM #community/Curve_Cycles__Full_Recursion
SORT file.name ASC
```

## Connections to other communities
- 8 edges to [[_COMMUNITY_Recursion Overview & History]]
- 6 edges to [[_COMMUNITY_ProtoStar & CycleFold]]
- 5 edges to [[_COMMUNITY_Proof Aggregation & Recursion Basics]]
- 4 edges to [[_COMMUNITY_Spartan, Halo & IVC Foundations]]
- 3 edges to [[_COMMUNITY_Proof-Carrying Data & Provenance]]
- 2 edges to [[_COMMUNITY_Nova & the Cycle-of-Curves Bug]]
- 2 edges to [[_COMMUNITY_Accumulation & Proofs of Solvency]]
- 2 edges to [[_COMMUNITY_Zexe & Decentralized Private Computation]]
- 1 edge to [[_COMMUNITY_IVC Foundations (Valiant)]]
- 1 edge to [[_COMMUNITY_Succinctness & Accumulation Schemes]]
- 1 edge to [[_COMMUNITY_Folding Schemes (LatticeFold)]]
- 1 edge to [[_COMMUNITY_Fiat-Shamir Attacks]]
- 1 edge to [[_COMMUNITY_Mina Recursive Blockchain]]
- 1 edge to [[_COMMUNITY_Poseidon Hash]]
- 1 edge to [[_COMMUNITY_STARK Recursion & Taxonomy]]
- 1 edge to [[_COMMUNITY_VerITAS Image Authentication]]

## Top bridge nodes
- [[Cycles of Elliptic Curves]] - degree 34, connects to 9 communities
- [[Pasta Curves]] - degree 9, connects to 2 communities
...
- [[Embedding degree of elliptic curve]] - degree 9, connects to 1 community