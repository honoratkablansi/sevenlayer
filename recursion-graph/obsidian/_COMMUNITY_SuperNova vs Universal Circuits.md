...
# SuperNova vs Universal Circuits
...
- [[SuperNova]] - document - recursion/recursion-outline.md
...
```dataview
TABLE source_file, type FROM #community/SuperNova_vs_Universal_Circuits
SORT file.name ASC
```

## Connections to other communities
- 4 edges to [[_COMMUNITY_SuperNova Non-Uniform IVC]]
...
- 1 edge to [[_COMMUNITY_ProtoStar & CycleFold]]

## Top bridge nodes
- [[SuperNova]] - degree 11, connects to 4 communities
...
- [[A la carte cost profile per-step proving cost proportional only to the circuit size of the invoked instruction, independent of k (number of instruction types)]] - degree 4, connects to 1 community
- [[Avoiding universal switch circuits SuperNova never builds a circuit summing all instruction circuits; per-step cost depends only on the executed instruction]] - degree 3, connects to 1 community
- [[Kothapalli, Setty, Tzialla, Nova (CRYPTO 2022)]] - degree 2, connects to 1 community