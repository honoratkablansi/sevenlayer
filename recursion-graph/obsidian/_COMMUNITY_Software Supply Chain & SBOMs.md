...
```dataview
TABLE source_file, type FROM #community/Software_Supply_Chain__SBOMs
SORT file.name ASC
```
...
- [[Compliance predicate  local property of distributed computation]] - degree 8, connects to 3 communities
