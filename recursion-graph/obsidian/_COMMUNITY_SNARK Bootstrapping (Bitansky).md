...
```dataview
TABLE source_file, type FROM #community/SNARK_Bootstrapping_Bitansky
SORT file.name ASC
```

## Connections to other communities
- 3 edges to [[_COMMUNITY_Recursion Overview & History]]
- 2 edges to [[_COMMUNITY_Proof-Carrying Data & Provenance]]
- 2 edges to [[_COMMUNITY_Software Supply Chain & SBOMs]]
...
- 1 edge to [[_COMMUNITY_Verifiable Databases (vSQL)]]
- 1 edge to [[_COMMUNITY_Recursive-Composition Soundness]]

## Top bridge nodes
- [[Bitansky-Canetti-Chiesa-Tromer Recursive Composition and Bootstrapping for SNARKs and PCD (STOC 2013)]] - degree 12, connects to 3 communities
- [[Valiant 2008 Incrementally-Verifiable Computation Val08]] - degree 3, connects to 2 communities
- [[Theorem 4  9.1 Main bootstrapping theorem (any SNARK - complexity-preserving SNARK and PCD)]] - degree 6, connects to 1 community
- [[Theorem 2 PCD Depth-Reduction (O(1)-depth PCD - poly-depth path PCD via wide Merkle proof trees)]] - degree 4, connects to 1 community
- [[Theorem 3 Locally-Efficient RAM Compliance (NP statement - poly-depth compliance predicate)]] - degree 4, connects to 1 community