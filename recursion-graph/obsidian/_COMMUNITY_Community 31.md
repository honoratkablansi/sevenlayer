...
- [[Proof of personhood]] - document - references/recursion/ch3/ref-83-zkpassport-anon-aadhaar.md
- [[Selective disclosure of the dependency tree (reveal only chosen subset, hide the rest)]] - paper - references/recursion/ch3/ref-61-verisbom.pdf
...
## Top bridge nodes
- [[Selective disclosure of the dependency tree (reveal only chosen subset, hide the rest)]] - degree 9, connects to 3 communities
