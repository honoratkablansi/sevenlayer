...
```dataview
TABLE source_file, type FROM #community/Verifiable_Delay_Functions
SORT file.name ASC
```

## Connections to other communities
- 5 edges to [[_COMMUNITY_IVC Foundations (Valiant)]]
...
- [[Verifiable delay function (VDF)]] - degree 20, connects to 1 community
