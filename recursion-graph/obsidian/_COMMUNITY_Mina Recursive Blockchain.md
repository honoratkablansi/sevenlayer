...
```dataview
TABLE source_file, type FROM #community/Mina_Recursive_Blockchain
SORT file.name ASC
```

## Connections to other communities
- 4 edges to [[_COMMUNITY_Recursion Overview & History]]
...
- [[TickTock SNARK pair (base, merge, wrap proofs over the curve cycle)]] - degree 2, connects to 1 community