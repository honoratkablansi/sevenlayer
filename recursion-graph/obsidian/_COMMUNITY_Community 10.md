...
- [[Zero-knowledge proof system (completeness, soundness, zero-knowledge; zkSNARK)]] - paper - references/recursion/ch3/ref-61-verisbom.pdf
...
## Top bridge nodes
- [[Zero-knowledge proof system (completeness, soundness, zero-knowledge; zkSNARK)]] - degree 13, connects to 3 communities
- [[DECO decentralized oracle for TLS (Zhang, Maram, Malvai, Goldfeder, Juels, CCS 2020)]] - degree 22, connects to 1 community
- [[Efficient selective opening of TLS records (RevealRedact modes) exploiting MAC-then-encrypt and Merkle-Damgard structure]] - degree 5, connects to 1 community
- [[Three demo applications confidential binary option, legacy-to-anonymous age credential, price-discrimination claim]] - degree 4, connects to 1 community
