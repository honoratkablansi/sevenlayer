...
- [[Merkle hash tree]] - document - references/recursion/ch3/ref-65-rfc-6962-certificate-transparency.md
...
```dataview
TABLE source_file, type FROM #community/Transparency_Logs__C2PA
SORT file.name ASC
```
