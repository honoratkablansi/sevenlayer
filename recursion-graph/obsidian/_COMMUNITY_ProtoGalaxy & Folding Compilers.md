...
- [[Binding Homomorphic (Pedersen) Vector Commitment]] - paper - references/ch06/ref-19-protostar.pdf
...
- [[ProtoGalaxy]] - document - recursion/recursion-outline.md
...
```dataview
TABLE source_file, type FROM #community/ProtoGalaxy__Folding_Compilers
SORT file.name ASC
```

## Connections to other communities
- 4 edges to [[_COMMUNITY_Succinctness & Accumulation Schemes]]
- 4 edges to [[_COMMUNITY_Folding Schemes (LatticeFold)]]
- 3 edges to [[_COMMUNITY_ProtoStar & CycleFold]]
- 2 edges to [[_COMMUNITY_IVC Foundations (Valiant)]]
- 1 edge to [[_COMMUNITY_Fiat-Shamir & Random-Oracle Model]]
- 1 edge to [[_COMMUNITY_CCS & Multifolding]]
- 1 edge to [[_COMMUNITY_Applications Cross-Chain & zkML]]

## Top bridge nodes
- [[Protostar Non-Uniform IVC Scheme for Multi-Circuit Plonkup R_mplkup]] - degree 10, connects to 2 communities
- [[ProtoGalaxy]] - degree 7, connects to 2 communities
...
- [[Generic AccumulationFolding Compiler for Special-Sound Protocols (4-step workflow)]] - degree 5, connects to 2 communities
- [[ProtoGalaxy Efficient ProtoStar-style folding of multiple instances (Eagen & Gabizon, ePrint 20231106)]] - degree 20, connects to 1 community