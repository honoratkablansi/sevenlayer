...
# Proof-Carrying Data & Provenance
...
- [[Proof-Carrying Data (PCD)]] - document - recursion/recursion-outline.md
...
```dataview
TABLE source_file, type FROM #community/Proof-Carrying_Data__Provenance
SORT file.name ASC
```

## Connections to other communities
- 6 edges to [[_COMMUNITY_PhotoProof Image Authentication]]
- 5 edges to [[_COMMUNITY_Succinctness & Accumulation Schemes]]
- 4 edges to [[_COMMUNITY_Accumulation & Proofs of Solvency]]
- 3 edges to [[_COMMUNITY_Software Supply Chain & SBOMs]]
- 3 edges to [[_COMMUNITY_Curve Cycles & Full Recursion]]
- 2 edges to [[_COMMUNITY_SNARK Bootstrapping (Bitansky)]]
- 2 edges to [[_COMMUNITY_Transparency Logs & C2PA]]
- 2 edges to [[_COMMUNITY_VerITAS Image Authentication]]
- 1 edge to [[_COMMUNITY_Recursion Overview & History]]
- 1 edge to [[_COMMUNITY_IVC Foundations (Valiant)]]
- 1 edge to [[_COMMUNITY_Rollups & Strategy Framework]]
- 1 edge to [[_COMMUNITY_HyperNova NIVC]]
- 1 edge to [[_COMMUNITY_Proof Aggregation & Recursion Basics]]
- 1 edge to [[_COMMUNITY_Nebra Universal Aggregation]]
- 1 edge to [[_COMMUNITY_Nova & the Cycle-of-Curves Bug]]
- 1 edge to [[_COMMUNITY_Recursive-Composition Soundness]]
- 1 edge to [[_COMMUNITY_Zexe & Decentralized Private Computation]]
- 1 edge to [[_COMMUNITY_Applications Cross-Chain & zkML]]

## Top bridge nodes
- [[Proof-Carrying Data (PCD)]] - degree 36, connects to 15 communities
- [[Media provenance]] - degree 10, connects to 4 communities
- [[PhotoProof cryptographic image authentication scheme for any permissible transformation set]] - degree 11, connects to 2 communities
- [[Compliance predicate encoded as Fp-Rank-1 Constraint System (R1CS); transformations built as image-processing gadgets (crop, flip, transpose, rotate, brightnesscontrast, identity)]] - degree 2, connects to 1 community