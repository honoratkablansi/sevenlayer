...
- [[Grand product argument (GKR-based)]] - paper - references/ch03/ref-16-jolt.pdf
- [[Lasso companion paper STW23 (Setty, Thaler, Wahby 2023)]] - paper - references/ch03/ref-16-jolt.pdf
- [[Lasso lookup argument]] - paper - references/ch03/ref-16-jolt.pdf
...
```dataview
TABLE source_file, type FROM #community/Lasso_Lookups__Jolt
SORT file.name ASC
```

## Connections to other communities
- 1 edge to [[_COMMUNITY_Sum-Check & CCS SNARKs]]
- 1 edge to [[_COMMUNITY_Memory Checking & Lookups]]
- 1 edge to [[_COMMUNITY_Fiat-Shamir & Random-Oracle Model]]

## Top bridge nodes
- [[Lasso lookup argument]] - degree 7, connects to 2 communities
- [[MSM commitment via Pippenger's algorithm]] - degree 2, connects to 1 community