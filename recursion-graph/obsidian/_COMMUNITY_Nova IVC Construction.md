...
- [[Fiat-Shamir Transform_1]] - paper - references/ch06/ref-17-nova.pdf
...
- [[Sum-Check Protocol_1]] - paper - references/ch06/ref-17-nova.pdf
...
```dataview
TABLE source_file, type FROM #community/Nova_IVC_Construction
SORT file.name ASC
```
...
- [[Nova IVC Scheme (Construction 3)]] - degree 6, connects to 1 community
- [[Non-Interactive Folding Scheme via Fiat-Shamir (Construction 2)]] - degree 4, connects to 1 community
- [[Sum-Check Protocol_1]] - degree 3, connects to 1 community