...
```dataview
TABLE source_file, type FROM #community/Fiat-Shamir_Attacks
SORT file.name ASC
```
...
- 3 edges to [[_COMMUNITY_Nova & the Cycle-of-Curves Bug]]
- 3 edges to [[_COMMUNITY_zkCNN & Convolution Proofs]]
- 2 edges to [[_COMMUNITY_Fiat-Shamir & Random-Oracle Model]]
- 2 edges to [[_COMMUNITY_Poseidon Hash]]
- 2 edges to [[_COMMUNITY_Fractal & Holographic Recursion]]
