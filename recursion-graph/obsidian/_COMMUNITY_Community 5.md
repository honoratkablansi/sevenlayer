...
## Members
- [[(Quantum) random oracle model and heuristic instantiation via cryptographic hash function]] - paper - references/recursion/ch1/ref-10-fractal.pdf
...
- [[Transparent (public-coin, toxic-waste-free) setup in the uniform reference string (URS) model]] - paper - references/recursion/ch1/ref-10-fractal.pdf
...
## Top bridge nodes
- [[(Quantum) random oracle model and heuristic instantiation via cryptographic hash function]] - degree 9, connects to 4 communities
