...
- [[Privacy-preserving  private smart contracts realizable via the RNK]] - paper - references/recursion/ch3/ref-90-zexe.pdf
...
- [[Zero-knowledge succinct non-interactive argument of knowledge (zkSNARK)]] - paper - references/recursion/ch3/ref-90-zexe.pdf
- [[Zerocash decentralized anonymous payments (prior work)]] - paper - references/recursion/ch3/ref-88-provisions.pdf
...
## Top bridge nodes
- [[Zexe a ledger-based system for decentralized private computation]] - degree 14, connects to 2 communities
- [[Zerocash decentralized anonymous payments (prior work)]] - degree 5, connects to 2 communities
- [[Bespoke depth-2 (one-layer) recursion inner predicate proofs verified by outer proof]] - degree 6, connects to 1 community
- [[Cocks-Pinch bounded recursion BLS12 curve E_BLS + Cocks-Pinch curve E_CP (avoids full cycle)]] - degree 4, connects to 1 community
- [[Prior recursive SNARK composition over a 2-cycle of curves BCTV17]] - degree 3, connects to 1 community