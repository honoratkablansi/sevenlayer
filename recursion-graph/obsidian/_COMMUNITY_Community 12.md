...
- [[Algebraic hash function native GF(p) arithmetic, low multiplicative complexity, succinct polynomial representation]] - paper - references/recursion/ch1/ref-31-poseidon.pdf
...
- [[Poseidon Hash]] - document - recursion/recursion-outline.md
...
## Top bridge nodes
- [[Poseidon Hash]] - degree 12, connects to 5 communities
- [[Sponge construction over the permutation rate r + capacity c; indifferentiable from random oracle up to 2{c2} calls]] - degree 5, connects to 1 community
- [[Arithmetization-friendly  low-constraint hashing over a large prime field for ZK proof circuits]] - degree 4, connects to 1 community