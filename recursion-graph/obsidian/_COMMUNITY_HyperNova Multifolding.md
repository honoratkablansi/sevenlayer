...
- [[HyperNova]] - document - recursion/recursion-outline.md
...
```dataview
TABLE source_file, type FROM #community/HyperNova_Multifolding
SORT file.name ASC
```

## Connections to other communities
- 5 edges to [[_COMMUNITY_ProtoStar & CycleFold]]
...
- 1 edge to [[_COMMUNITY_Sum-Check & CCS SNARKs]]
- 1 edge to [[_COMMUNITY_Nova IVC Construction]]

## Top bridge nodes
- [[Construction 1 multi-folding scheme for CCS over a cycle of curves]] - degree 9, connects to 3 communities
- [[HyperNova]] - degree 9, connects to 2 communities
- [[Multi-folding scheme]] - degree 3, connects to 1 community
- [[Nova reference implementation (microsoftNova)]] - degree 3, connects to 1 community
- [[Multifolding]] - degree 2, connects to 1 community