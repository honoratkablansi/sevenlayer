...
- [[FFLONK]] - document - references/recursion/ch1/ref-17-polygon-zkevm-docs.md
...
- [[PLONK universal SNARK]] - paper - references/recursion/ch1/ref-21-zktree.pdf
...
```dataview
TABLE source_file, type FROM #community/VerITAS_Image_Authentication
SORT file.name ASC
```

## Connections to other communities
- 3 edges to [[_COMMUNITY_Recursion Overview & History]]
- 3 edges to [[_COMMUNITY_STARK Recursion & Taxonomy]]
- 3 edges to [[_COMMUNITY_Polynomial-Commitment Accumulation]]
- 3 edges to [[_COMMUNITY_Applications Cross-Chain & zkML]]
...
- 1 edge to [[_COMMUNITY_Curve Cycles & Full Recursion]]
- 1 edge to [[_COMMUNITY_PhotoProof Image Authentication]]

## Top bridge nodes
- [[VerITAS Verifying Image Transformations at Scale (Datta, Chen, Boneh, ePrint 20241066)]] - degree 22, connects to 6 communities
- [[PLONK universal SNARK]] - degree 9, connects to 4 communities
- [[Image Authentication (IA) proving an image faithfully represents an original photograph from a given capture device class]] - degree 6, connects to 2 communities
