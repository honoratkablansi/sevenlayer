...
- [[Embedding degree of elliptic curve]] - `conceptually_related_to` [EXTRACTED]
...
- [[MNT4MNT6 2-cycle (E4, E6) at 80-bit security]] - `defines` [EXTRACTED]
- [[Miyaji, Nakabayashi & Takano MNT01 - characterization of prime-order curves with k=3,4,6]] - `defines` [EXTRACTED]
- [[PCD-friendly 2-cycle (base field of one curve = group order of other)]] - `conceptually_related_to` [EXTRACTED]
