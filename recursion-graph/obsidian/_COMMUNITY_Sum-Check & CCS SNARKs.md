...
- [[Multilinear  Low-Degree Extension unique multilinear polynomial agreeing with a function on the Boolean hypercube]] - paper - references/recursion/ch1/ref-20-thaler-proofs-arguments-zk.pdf
...
```dataview
TABLE source_file, type FROM #community/Sum-Check__CCS_SNARKs
SORT file.name ASC
```

## Connections to other communities
- 6 edges to [[_COMMUNITY_Spartan, Halo & IVC Foundations]]
- 6 edges to [[_COMMUNITY_zkCNN & Convolution Proofs]]
- 5 edges to [[_COMMUNITY_Verifiable Databases (vSQL)]]
- 3 edges to [[_COMMUNITY_Polynomial-Commitment Accumulation]]
- 3 edges to [[_COMMUNITY_LatticeFold+ Range Proofs]]
- 3 edges to [[_COMMUNITY_GKR & Delegation (Muggles)]]
- 2 edges to [[_COMMUNITY_CCS & Multifolding]]
- 2 edges to [[_COMMUNITY_Lattice CCS Folding]]
- 2 edges to [[_COMMUNITY_Fiat-Shamir & Random-Oracle Model]]
- 1 edge to [[_COMMUNITY_Relaxed R1CS & Cross-Terms]]
- 1 edge to [[_COMMUNITY_Lasso Lookups & Jolt]]
- 1 edge to [[_COMMUNITY_HyperNova Multifolding]]
- 1 edge to [[_COMMUNITY_Folding Schemes (LatticeFold)]]
- 1 edge to [[_COMMUNITY_STARKs & Post-Quantum Folding]]
- 1 edge to [[_COMMUNITY_LatticeFold+ Folding]]

## Top bridge nodes
- [[Sum-Check Protocol]] - degree 29, connects to 12 communities
- [[Multilinear  Low-Degree Extension unique multilinear polynomial agreeing with a function on the Boolean hypercube]] - degree 14, connects to 7 communities
- [[SuperSpartan SNARK family for CCS generalizing Spartan's polynomial IOP]] - degree 6, connects to 2 communities
- [[New sum-check protocol for FFT with O(N) linear prover time (faster than computing the FFT)]] - degree 6, connects to 1 community
- [[Polynomial IOP  interactive oracle protocol]] - degree 2, connects to 1 community