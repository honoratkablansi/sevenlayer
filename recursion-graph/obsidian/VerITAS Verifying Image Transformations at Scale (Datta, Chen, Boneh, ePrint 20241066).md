...
type: "paper"
community: "VerITAS Image Authentication"
location: "title/abstract"
tags:
  - graphify/paper
  - graphify/EXTRACTED
  - community/VerITAS_Image_Authentication
---

# VerITAS: Verifying Image Transformations at Scale (Datta, Chen, Boneh, ePrint 2024/1066)

## Connections
- [[C2PA (Coalition for Content Provenance and Authenticity) camera-signature standard]] - `assumes` [EXTRACTED]
- [[Custom proof system for lattice hash range proof (Plookup) + Freivalds + univariate SumCheck (Aurora)]] - `introduces` [EXTRACTED]
- [[Extended PLONK permutation argument (tau') tying circuit trace T(X) to witness polynomial W(X)]] - `introduces` [EXTRACTED]
- [[Glass-to-glass end-to-end security (camera to user screen, no trusted editor)]] - `introduces` [EXTRACTED]
- [[Homomorphic  redactable signatures (alternate, SNARK-free designs; impractical for blurresize)]] - `cites` [EXTRACTED]
...
- [[PLONK universal SNARK]] - `assumes` [EXTRACTED]
...
- [[Photo-edit circuits in Plonky2 crop, grayscale, bilinear resize, box blur (fixed-point, AP-acceptable edits)]] - `introduces` [EXTRACTED]
...
- [[zk-SNARK succinct non-interactive argument of knowledge (completeness, knowledge soundness, zero knowledge) (Def 2.2)]] - `assumes` [EXTRACTED]

#graphify/paper #graphify/EXTRACTED #community/VerITAS_Image_Authentication