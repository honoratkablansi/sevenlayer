...
- **GRAPH:** C7 (Interactive Proof 47), C17 (Fiat-Shamir 105, NIZK, CRS), C9 (Trust Minimization), seven-layer spine map.
...
- **SPIRAL:** locks Ch 1's three properties as formal definitions and Ch 2's "succinct" slogan. **DEBT PAID:** the Part I "why does the math work" note is discharged in full — the biggest click.
...
- **PAYLOAD:** **Recursive proof composition** (the #1 absent god-node, degree 83 — a verifier *is* a circuit, needing FS-in-circuit from Ch 12); **IVC** with its two-independence-condition definition; **PCD** (the DAG generalization); the **cycles-of-curves payoff** from Ch 11; **STARK-to-SNARK** recursion and proof compression; the **bootstrapping ↔ IVC** parallel.
